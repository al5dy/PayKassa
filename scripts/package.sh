...
mkdir -p "$release_dir"
rsync -a --delete --delete-excluded --exclude='/.git/***' --exclude='/.github/***' --exclude='/.idea/***' --exclude='/.playwright-cli/***' --exclude='/output/***' --exclude='/node_modules/***' --exclude='/vendor/***' --exclude='/tests/***' --exclude='/docs/***' --exclude='/scripts/***' --exclude='/dist/***' --exclude='/includes/***' --exclude='/assets/src/***' --exclude='/*.zip' --exclude='/AGENTS.md' --exclude='/API.md' --exclude='/PaykassaAPI.md' --exclude='/PaykassaSCI.md' --exclude='/composer.json' --exclude='/composer.lock' --exclude='/package.json' --exclude='/.gitignore' --exclude='/phpcs.xml.dist' --exclude='/phpstan.neon' --exclude='/phpunit.xml.dist' --exclude='/.phpunit.result.cache' --exclude='*.po~' --exclude='*.log' "$base_dir/" "$release_dir/"
